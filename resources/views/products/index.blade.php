...
<div class="row">
  ...
  <div class="col-lg-10 offset-1 shadow-lg p-3 mb-5 bg-white rounded ">
    <div class="card">
      <div class="card-body">
        <!-- 筛选组件开始 -->
        <!-- 筛选组件结束 -->
            ...
            <div  class="col-lg-3 col-md-4 col-sm-6 product-item text-center">
              <div class="product-content">
                <div class="top">
                  ...
                  <a href="{{ route('products.show', ['product' => $product->id]) }}"><button class="btn btn-primary mb-1"> Xem Chi Tiết Sản Phẩm</button></a>
                </div>
                <div class="bottom">
